locals {
  lambda_functions = {
    ...
    self_memories_post = {
      handler     = "self-memories-post.handler"
      source_file = "${path.module}/../apps/backend/dist/lambda/self-memories-post.js"
      memory_size = 256
      timeout     = 15
    ...
    self_memories_id_delete = {
      handler     = "self-memories-id-delete.handler"
      source_file = "${path.module}/../apps/backend/dist/lambda/self-memories-id-delete.js"
      memory_size = 256
      timeout     = 15
    ...
    self_plans_id_favorites_delete = {
      handler     = "self-plans-id-favorites-delete.handler"
      source_file = "${path.module}/../apps/backend/dist/lambda/self-plans-id-favorites-delete.js"
      memory_size = 256
      timeout     = 15
    ...
    self_plans_id_delete = {
      handler     = "self-plans-id-delete.handler"
      source_file = "${path.module}/../apps/backend/dist/lambda/self-plans-id-delete.js"
      memory_size = 256
      timeout     = 15
    ...
    self_plans_id_items_put = {
      handler     = "self-plans-id-items-put.handler"
      source_file = "${path.module}/../apps/backend/dist/lambda/self-plans-id-items-put.js"
      memory_size = 256
      timeout     = 15
